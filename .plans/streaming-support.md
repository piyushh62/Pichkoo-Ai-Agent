# Streaming LLM Response Support for Pichkoo AI Agent
...
```
PICHKOO_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("PICHKOO_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `pichkoo_cli/config.py` | 1 | +streaming config defaults |
...
PICHKOO_STREAMING_ENABLED=true
```
