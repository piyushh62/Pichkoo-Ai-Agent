...
(3 SDK retries x 3 Pichkoo retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_pichkoo_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".pichkoo")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Pichkoo, ...) behind one endpoint.  A 429 can mean either:
