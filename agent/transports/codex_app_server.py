...
projection into Pichkoo' display, approval bridging, transcript projection into
...
"codex_app_server"`. Pichkoo' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("PICHKOO_KANBAN_TASK"):
            kanban_db = spawn_env.get("PICHKOO_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "PICHKOO_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("PICHKOO_HOME", os.path.expanduser("~/.pichkoo")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "pichkoo",
        client_title: str = "Pichkoo AI Agent",
