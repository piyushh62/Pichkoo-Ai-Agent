...
cd apps/desktop
XCURSOR_SIZE=24 PICHKOO_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/pichkoo-typing
# → /tmp/pichkoo-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/pichkoo-typing.before.heapsnapshot
# → /tmp/pichkoo-typing.after.heapsnapshot
```
