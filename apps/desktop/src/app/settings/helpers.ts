import type { PichkooConfigRecord, ToolsetInfo } from '@/types/pichkoo'
...
export function getNested(obj: PichkooConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: PichkooConfigRecord, path: string, value: unknown): PichkooConfigRecord {
...
function personalityOptions(config: PichkooConfigRecord): string[] {
