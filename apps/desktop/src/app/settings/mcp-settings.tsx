...
import { getPichkooConfigRecord, type PichkooGateway, savePichkooConfig } from '@/pichkoo'
import { useI18n } from '@/i18n'
import { Wrench } from '@/lib/icons'
import { cn } from '@/lib/utils'
import { notify, notifyError } from '@/store/notifications'
import { $activeSessionId } from '@/store/session'
import type { PichkooConfigRecord } from '@/types/pichkoo'
...
function getServers(config: PichkooConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await savePichkooConfig(nextConfig)
