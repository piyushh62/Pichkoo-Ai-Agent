...
import { deleteSession, listSessions, setSessionArchived } from '@/pichkoo'
...
// / Program Files), which buried any files Pichkoo wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.pichkooDesktop` is
    ...
    const settings = window.pichkooDesktop?.settings
