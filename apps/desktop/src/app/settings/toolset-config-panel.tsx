...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/pichkoo'
 ...
 * log inline — the GUI equivalent of the install step `pichkoo tools` runs
