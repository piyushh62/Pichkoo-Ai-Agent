...
export const en: Translations = {
  ...
  boot: {
    ready: 'Pichkoo Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Pichkoo settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingPichkooDesktop: 'Starting Pichkoo Desktop…'
    },
    errors: {
      backgroundExited: 'Pichkoo background process exited.',
      backgroundExitedDuringStartup: 'Pichkoo background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Pichkoo backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Pichkoo Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Pichkoo defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Pichkoo follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Pichkoo checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Pichkoo configuration...',
    ...
    gateway: {
      ...
      intro:
        'Pichkoo Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Pichkoo backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset PICHKOO_DESKTOP_REMOTE_URL and PICHKOO_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Pichkoo backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Pichkoo backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /pichkoo.',
      ...
      restartingMessage: 'Pichkoo Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Pichkoo ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Pichkoo runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Pichkoo desktop' },
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@pichkoo:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Pichkoo environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Pichkoo will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Pichkoo...',
    placeholderReconnecting: 'Reconnecting to Pichkoo…',
    ...
    attachUrlDesc: 'Pichkoo will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Pichkoo can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Pichkoo from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Pichkoo will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Pichkoo updater will take over in its own window and reopen Pichkoo when it’s done.',
    applyingBodyBackend: 'The remote backend is applying the update and will restart. Pichkoo reconnects automatically when it’s back.',
    applyingClose: 'Pichkoo will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Pichkoo needs a one-time install',
    ...
    settingUpTitle: 'Setting up Pichkoo AI Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Pichkoo CLI or desktop instance is running. Stop any running Pichkoo instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Pichkoo installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Pichkoo AI Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Pichkoo is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Pichkoo…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Pichkoo',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Pichkoo at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Pichkoo connects automatically',
      loopback: 'Opens your browser to sign in — Pichkoo connects automatically',
    ...
    authorizeThere: 'Authorize Pichkoo there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Pichkoo there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Pichkoo Desktop v${version}`,
      ...
      gatewayTitle: 'Pichkoo inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Pichkoo will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Pichkoo is restarting...',
      askRestart: 'Ask Pichkoo to restart the server',
      lookingRestart: taskId => `Pichkoo is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Pichkoo is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Pichkoo finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Pichkoo could not restart the server.',
      stillWorking:
        'Pichkoo is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Pichkoo is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Pichkoo gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.pichkoo/config.yaml). Pichkoo won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Pichkoo needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Pichkoo needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Pichkoo Desktop to use Save Image.',
    restartToSaveImages: 'Restart Pichkoo Desktop to save images',
