...
Config: ~/.pichkoo/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.pichkoo/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_pichkoo_home()`` helper (PICHKOO_HOME-aware and
...
RULES_FILE = get_pichkoo_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_pichkoo_home() / "feishu_comment_pairing.json"
