...
try:
    ...
    _PICHKOO_VERSION = "0.0.0"

_APP_VERSION = _PICHKOO_VERSION
_BOT_VERSION = _PICHKOO_VERSION
_YUANBAO_INSTANCE_ID = str(PICHKOO_INSTANCE_ID)  # single source: yuanbao_proto.PICHKOO_INSTANCE_ID
