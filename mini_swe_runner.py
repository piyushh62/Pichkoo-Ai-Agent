#!/usr/bin/env python3
"""
SWE Runner with Pichkoo Trajectory Format

A runner that uses Pichkoo-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Pichkoo-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Pichkoo-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Pichkoo format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Pichkoo-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Pichkoo-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Pichkoo Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Pichkoo-Agent's built-in execution environments
    and outputs trajectories in Pichkoo-Agent format.
    """
    ...
    def _convert_to_pichkoo_format(
        self,
        ...
        """
        Convert internal message format to Pichkoo trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Pichkoo trajectory format
        trajectory = self._convert_to_pichkoo_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Pichkoo trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Pichkoo Trajectory Format")
    print("=" * 60)
