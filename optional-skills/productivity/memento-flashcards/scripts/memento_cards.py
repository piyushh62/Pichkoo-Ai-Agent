...
Data file: $PICHKOO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_PICHKOO_HOME = Path(os.environ.get("PICHKOO_HOME", Path.home() / ".pichkoo"))
DATA_DIR = _PICHKOO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
