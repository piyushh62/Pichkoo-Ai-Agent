...
2. Refresh Python resources with `brew update-python-resources --print-only pichkoo-agent`.
3. Keep `ignore_packages: %w[certifi cryptography pydantic]`.
4. Verify `brew audit --new --strict pichkoo-agent` and `brew test pichkoo-agent`.
