...
Used by ``pichkoo profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``pichkoo_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Pichkoo AI Agent kanban board.
...
Rules:
  ...
  - Never write "Pichkoo AI Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_pichkoo_home())
        else:
