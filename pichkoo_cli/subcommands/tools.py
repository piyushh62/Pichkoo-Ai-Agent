"""``pichkoo tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'pichkoo tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # pichkoo tools list [--platform cli]
    ...
    # pichkoo tools disable <name...> [--platform cli]
    ...
    # pichkoo tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `pichkoo tools` runs after you pick a provider that\n"
