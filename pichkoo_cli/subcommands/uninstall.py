"""``pichkoo uninstall`` subcommand parser.
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall Pichkoo AI Agent",
        description="Remove Pichkoo AI Agent from your system. Can keep configs/data for reinstall.",
    )
