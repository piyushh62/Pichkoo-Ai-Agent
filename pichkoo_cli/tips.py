...
TIPS = [
    ...
    "pichkoo mcp serve runs Hermes itself as an MCP server for other agents.",
    ...
    "pichkoo backup creates a zip backup of your entire Hermes home directory.",
    ...
    "pichkoo gateway install sets up Hermes as a system service (systemd/launchd).",
    ...
    "Hermes loads project context from .pichkoo.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "pichkoo acp runs Hermes as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    'pichkoo dashboard embeds the full Hermes TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'HERMES_ENABLE_PROJECT_PLUGINS=1 auto-loads repo-local plugins from ./.pichkoo/plugins/ — trust-gated by design.',
