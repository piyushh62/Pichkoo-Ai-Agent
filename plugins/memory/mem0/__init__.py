...
def _load_config() -> dict:
    ...
    config = {
        ...
        "user_id": os.environ.get("MEM0_USER_ID", "pichkoo-user"),
        "agent_id": os.environ.get("MEM0_AGENT_ID", "pichkoo"),
        "rerank": True,
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "user_id", "description": "User identifier", "default": "pichkoo-user"},
            {"key": "agent_id", "description": "Agent identifier", "default": "pichkoo"},
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._user_id = kwargs.get("user_id") or self._config.get("user_id", "pichkoo-user")
        self._agent_id = self._config.get("agent_id", "pichkoo")
