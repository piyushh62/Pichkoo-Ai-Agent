# Pichkoo Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.pichkoo/plugins/pichkoo-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.pichkoo/plugins/pichkoo-achievements/scan_checkpoint.json`.
