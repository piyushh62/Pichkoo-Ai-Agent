# Pichkoo Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.pichkoo/plugins/pichkoo-achievements/state.json` (existing unlock state)
  - `~/.pichkoo/plugins/pichkoo-achievements/scan_snapshot.json` (new)
  - `~/.pichkoo/plugins/pichkoo-achievements/scan_checkpoint.json` (new)
