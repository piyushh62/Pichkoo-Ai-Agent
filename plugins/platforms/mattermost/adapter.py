...
required — uses aiohttp which is already a Pichkoo dependency.
...
def interactive_setup() -> None:
    ...
    ``pichkoo_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Pichkoo delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # pichkoo_cli/setup.py::_setup_mattermost function.
