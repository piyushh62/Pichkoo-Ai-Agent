...
Credential storage mirrors every other Pichkoo channel:
...
# registers Pichkoo as its own client_id.
...
# Default name of the project Pichkoo provisions for the operator.
DEFAULT_PROJECT_NAME = "Pichkoo AI Agent"
