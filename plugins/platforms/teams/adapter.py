"""
Microsoft Teams platform adapter for Pichkoo AI Agent.
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "Pichkoo"}),
            )
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"Pichkoo\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
    ...
    print()
    print_success("Teams configuration saved to ~/.pichkoo/.env")
