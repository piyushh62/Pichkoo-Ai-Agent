...
``{title, url, description, position}`` rows every other Pichkoo web
provider produces.
...
prefers Pichkoo-managed xAI Grok OAuth (via ``pichkoo auth``) and falls back
