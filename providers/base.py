...
def _profile_user_agent() -> str:
    """Return a ``pichkoo-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from pichkoo_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"pichkoo-cli/{_ver}"
    except Exception:
        return "pichkoo-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # pichkoo-cli UA so the catalog endpoint is reachable.
