#!/usr/bin/env python3
"""Build the Pichkoo Skills Index — a centralized JSON catalog of all skills.
...
`pichkoo skills search/install` can use it without hitting the GitHub API.
...
# Ensure PICHKOO_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Pichkoo Skills Index...", flush=True)
