...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Pichkoo\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "pichkoo@nousresearch.com",
    "pichkoo-audit@example.com",
    "pichkoo@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/pichkoo-agent",
                "--state", "merged",
