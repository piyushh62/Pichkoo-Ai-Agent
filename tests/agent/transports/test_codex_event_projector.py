"""Tests for CodexEventProjector — codex item/* events → Pichkoo messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Pichkoo' message alternation invariant."""
