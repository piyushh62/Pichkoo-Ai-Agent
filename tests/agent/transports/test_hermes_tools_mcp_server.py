...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import pichkoo_tools_mcp_server as m
    ...
    def test_exposed_tools_are_safe_subset(self):
        ...
        from agent.transports.pichkoo_tools_mcp_server import EXPOSED_TOOLS
        forbidden = {
    ...
    def test_expected_pichkoo_specific_tools_listed(self):
        """The Pichkoo-specific tools should be present so users on the
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.pichkoo_tools_mcp_server as m
