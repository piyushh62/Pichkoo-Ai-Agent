...
class TestLightModeDetection:
    ...
    def test_pichkoo_light_env_false_forces_dark(self, cli_mod, monkeypatch):
        ...
        monkeypatch.delenv("PICHKOO_TUI_THEME", raising=False)
        monkeypatch.delenv("PICHKOO_TUI_BACKGROUND", raising=False)
        monkeypatch.delenv("COLORFGBG", raising=False)
        assert cli_mod._detect_light_mode() is False

    def test_theme_hint_light(self, cli_mod, monkeypatch):
        monkeypatch.delenv("PICHKOO_LIGHT", raising=False)
        monkeypatch.delenv("PICHKOO_TUI_LIGHT", raising=False)
        monkeypatch.setenv("PICHKOO_TUI_THEME", "light")
        assert cli_mod._detect_light_mode() is True
    ...
    def test_background_hex_hint_light(self, cli_mod, monkeypatch):
        ...
        monkeypatch.delenv("PICHKOO_TUI_LIGHT", raising=False)
        monkeypatch.delenv("PICHKOO_TUI_THEME", raising=False)
        monkeypatch.setenv("PICHKOO_TUI_BACKGROUND", "#FFFFFF")
        assert cli_mod._detect_light_mode() is True
    ...
    def test_background_hex_hint_dark(self, cli_mod, monkeypatch):
        ...
        monkeypatch.delenv("PICHKOO_TUI_LIGHT", raising=False)
        monkeypatch.delenv("PICHKOO_TUI_THEME", raising=False)
        monkeypatch.setenv("PICHKOO_TUI_BACKGROUND", "#1a1a2e")
        monkeypatch.delenv("COLORFGBG", raising=False)
        assert cli_mod._detect_light_mode() is False
