...
The unit tests in tests/pichkoo_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned pichkoo-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/pichkoo")
from pichkoo_cli.service_manager import S6ServiceManager
