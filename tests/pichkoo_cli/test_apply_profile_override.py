...
When HERMES_HOME is set to the pichkoo root (e.g. systemd hardcodes
HERMES_HOME=/root/.pichkoo), _apply_profile_override must still read
...
class TestApplyProfileOverrideHermesHomeGuard:
    ...
    Verifies that HERMES_HOME pointing to the pichkoo root does NOT suppress
    ...
    def test_hermes_home_at_root_with_active_profile_is_redirected(
        ...
        """HERMES_HOME=/root/.pichkoo + active_profile=coder must redirect
        HERMES_HOME to .../profiles/coder.

        Bug scenario from #22502: systemd sets HERMES_HOME to the pichkoo root
