"""Tests for the specifier module + `pichkoo kanban specify` CLI surface.
...
from pichkoo_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `pichkoo kanban …` argparse surface directly."""
