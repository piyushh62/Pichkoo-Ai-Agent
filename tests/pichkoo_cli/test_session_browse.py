"""Tests for the interactive session browser (`pichkoo sessions browse`).
...
from pichkoo_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """pichkoo sessions browse should be parseable."""
