...
The main() function in pichkoo_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `pichkoo -c model`
...
def _build_parser():
    """Build a minimal replica of the pichkoo top-level parser."""
