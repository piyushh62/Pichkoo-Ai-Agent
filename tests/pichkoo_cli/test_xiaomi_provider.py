...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from pichkoo_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in PICHKOO_OVERLAYS
        overlay = PICHKOO_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify pichkoo doctor recognizes Xiaomi env vars."""
