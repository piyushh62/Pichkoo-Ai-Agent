...
See: https://github.com/piyushh62/Pichkoo-AI-Agent/issues/4426
"""
...
class TestGetSubprocessHome:
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        base = tmp_path / ".pichkoo" / "profiles"
        ...
        monkeypatch.setenv("PICHKOO_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("PICHKOO_HOME", str(base / "beta"))
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from pichkoo_cli.profiles import _PROFILE_DIRS
