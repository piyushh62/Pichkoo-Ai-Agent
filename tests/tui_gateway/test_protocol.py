...
def test_disable_flush_env_var_actually_wires_to_module_constant(monkeypatch):
    """End-to-end: setting `PICHKOO_TUI_GATEWAY_NO_FLUSH=1` and importing
    ...
    monkeypatch.setenv("PICHKOO_TUI_GATEWAY_NO_FLUSH", "1")
    ...
    try:
        ...
        monkeypatch.delenv("PICHKOO_TUI_GATEWAY_NO_FLUSH", raising=False)
