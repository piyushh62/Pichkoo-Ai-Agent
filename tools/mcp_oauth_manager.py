...
# ---------------------------------------------------------------------------
# PichkooMCPOAuthProvider — OAuthClientProvider subclass with disk-watch
# ---------------------------------------------------------------------------
...
def _make_pichkoo_provider_class() -> Optional[type]:
    ...
    class PichkooMCPOAuthProvider(OAuthClientProvider):
        ...
        async def _initialize(self) -> None:
            ...
            Paired with :class:`PichkooTokenStorage` persisting an absolute
            ...
            if (
                isinstance(storage, PichkooTokenStorage)
            ...
            async with httpx.AsyncClient(timeout=10.0) as client:
                ...
                for url in build_oauth_authorization_server_metadata_discovery_urls(
                    ...
                    if asm:
                        ...
                        storage = self.context.storage
                        from tools.mcp_oauth import PichkooTokenStorage
                        if isinstance(storage, PichkooTokenStorage):
        ...
        def _persist_oauth_metadata_if_changed(self) -> None:
            ...
            storage = self.context.storage
            from tools.mcp_oauth import PichkooTokenStorage
            if not isinstance(storage, PichkooTokenStorage):
                return
    ...
    return PichkooMCPOAuthProvider
...
class MCPOAuthManager:
    ...
    def _build_provider(
        ...
        Constructs :class:`PichkooMCPOAuthProvider` directly using the helpers
