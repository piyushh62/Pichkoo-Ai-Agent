 ...
 *
 * Symptom: in `pichkoo --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@pichkoo/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using pichkoo --tui and as i type multiline my caret at the end will often ' +
