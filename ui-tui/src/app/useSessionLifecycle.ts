...
import type { ScrollBoxHandle } from '@pichkoo/ink'
import { evictInkCaches } from '@pichkoo/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.PICHKOO_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
