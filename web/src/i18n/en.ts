...
export const en: Translations = {
  ...
  status: {
    ...
    updatingPichkoo: "Updating Pichkoo…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Pichkoo plugins (`pichkoo plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.pichkoo/plugins/?",
    removeHint: "Only user-installed plugins under ~/.pichkoo/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.pichkoo/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Pichkoo badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Pichkoo session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Pichkoo more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Pichkoo sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Pichkoo is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
