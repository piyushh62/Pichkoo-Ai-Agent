...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updatePichkoo: "Aggiorna Pichkoo",
    updatingPichkoo: "Aggiornamento di Pichkoo…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Pichkoo (parità con `pichkoo plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.pichkoo/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.pichkoo/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.pichkoo/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Pichkoo da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Pichkoo in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Pichkoo di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Pichkoo rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Pichkoo sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
