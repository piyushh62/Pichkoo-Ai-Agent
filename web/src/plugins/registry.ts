 ...
 *
 * Plugins call window.__PICHKOO_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__PICHKOO_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__PICHKOO_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__PICHKOO_PLUGIN_SDK__ = {
    ...
    // window.__PICHKOO_SESSION_TOKEN__ directly.
    authedFetch,
