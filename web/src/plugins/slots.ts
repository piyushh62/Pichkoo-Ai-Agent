 ...
 * `window.__PICHKOO_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Pichkoo brand in the top bar
 ...
 *  `window.__PICHKOO_PLUGINS__.registerSlot(...)`.
 *
