...
const STORAGE_KEY = "pichkoo-dashboard-theme";
...
const FONT_STORAGE_KEY = "pichkoo-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `pichkoo_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "pichkoo-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-pichkoo-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-pichkoo-theme-font", "true");
