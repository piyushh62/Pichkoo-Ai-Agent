 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `pichkoo_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Pichkoo Teal",
  description: "Classic dark teal — the canonical Pichkoo look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Pichkoo look, ported from the
 ...
 * nousnet-web's <body> is white; pichkoo-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Pichkoo Teal (Large)",
  description: "Pichkoo Teal with bigger fonts and roomier spacing",
