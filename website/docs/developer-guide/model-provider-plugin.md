...
See [Building a Pichkoo Plugin](/guides/build-a-hermes-plugin#distribute-via-pip) for the full entry-points setup.
...
- [Building a Pichkoo Plugin](/guides/build-a-hermes-plugin) — general plugin authoring
