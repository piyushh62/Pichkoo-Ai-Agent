...
|----------|-------|-------------|-------|
| 1 | `.pichkoo.md`, `HERMES.md` | CWD up to git root | Pichkoo-native project config |
...
1. `.pichkoo.md` / `HERMES.md` (walks to git root)
...
- Project context files such as `.pichkoo.md`, `HERMES.md`, `AGENTS.md`, `CLAUDE.md`, or `.cursorrules` — inject repo-specific working rules.
