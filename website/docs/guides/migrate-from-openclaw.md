...
`hermes claw migrate` imports your OpenClaw (or legacy Clawdbot/Moldbot) setup into Pichkoo. This guide covers exactly what gets migrated, the config key mappings, and what to verify after migration.
