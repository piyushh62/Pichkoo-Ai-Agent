---
sidebar_position: 8
title: "Use Voice Mode with Pichkoo"
description: "A practical guide to setting up and using Pichkoo voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Pichkoo
...
- you want Pichkoo sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Pichkoo.
...
## Step 1: make sure normal Pichkoo works first
...
Pichkoo supports both local and cloud speech stacks.
...
4. Pichkoo transcribes and responds
...
- asking Pichkoo to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Pichkoo loop.

## Tuning CLI behavior

### Silence threshold

If Pichkoo starts/stops too aggressively, tune:
...
Pichkoo stays a normal chat bot, but can speak replies.
...
- you want Pichkoo to function like a portable research or ops assistant
...
Pichkoo joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Pichkoo detects speech boundaries
- transcripts are posted in the associated text channel
- Pichkoo responds in text and audio
