...
chat completions — use your Pichkoo-managed provider subscription as their
...
| Use case | "Use Pichkoo as a chat backend" | "Use my Portal sub from another app" |
...
Model:      Pichkoo-4-70B    # or Pichkoo-4.3-36B, Pichkoo-4-405B
```
