...
Set your Tenor API key in your environment (add to `~/.pichkoo/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/pichkoo-agent/blob/main/skills/media/gif-search/url)`
