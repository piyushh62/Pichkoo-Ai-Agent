---
title: "Pichkoo AI Agent Skill Authoring — Author in-repo SKILL"
sidebar_label: "Pichkoo AI Agent Skill Authoring"
description: "Author in-repo SKILL"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Pichkoo AI Agent Skill Authoring
...
| Path | `skills/software-development/pichkoo-agent-skill-authoring` |
| Version | `1.0.0` |
...
# Authoring Pichkoo-Agent Skills (in-repo)
...
- Pichkoo-specific recipes (tests via scripts/run_tests.sh, ui-tui paths, etc.)
