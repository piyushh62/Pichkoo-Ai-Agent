...
| | |
|---|---|
| Source | Optional — install with `pichkoo skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Pichkoo AI Agent |
| License | MIT |
...
The script reads `~/.pichkoo/.env` for two optional defaults:
...
Helper script: `~/.pichkoo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.pichkoo/.env`.
