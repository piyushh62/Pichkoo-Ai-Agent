...
| | |
|---|---|
| Source | Optional — install with `pichkoo skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Pichkoo AI Agent |
| License | MIT |
...
Helper script path: ~/.pichkoo/skills/blockchain/solana/scripts/solana_client.py
