...
| | |
|---|---|
| Source | Optional — install with `pichkoo skills install official/health/neuroskill-bci` |
...
Connect Pichkoo to a running [NeuroSkill](https://neuroskill.com/) instance to read
