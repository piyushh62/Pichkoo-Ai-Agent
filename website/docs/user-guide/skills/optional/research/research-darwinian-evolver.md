...
| | |
|---|---|
| Source | Optional — install with `pichkoo skills install official/research/darwinian-evolver` |
...
import upstream classes into Pichkoo itself.
...
Open `~/.pichkoo/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Pichkoo core.
   Custom driver scripts under `~/.pichkoo/skills/...` are user-side and fine.
