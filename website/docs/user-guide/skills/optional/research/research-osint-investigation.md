...
| | |
|---|---|
| Source | Optional — install with `pichkoo skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Pichkoo AI Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $PICHKOO_OSINT_CACHE/icij/ (default: ~/.cache/pichkoo-osint/icij/).
...
# Set PICHKOO_OSINT_UA=your-app/1.0 (your@email) to identify yourself
