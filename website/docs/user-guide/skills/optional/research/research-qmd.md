...
| | |
|---|---|
| Source | Optional — install with `pichkoo skills install official/research/qmd` |
...
Pichkoo AI Agent via the native MCP client. This is the preferred
...
Then configure Pichkoo AI Agent to connect via HTTP:
