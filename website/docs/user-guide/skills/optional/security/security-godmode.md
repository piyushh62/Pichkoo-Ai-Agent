...
exec(open(os.path.expanduser(
    os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.pichkoo")), "skills/red-teaming/godmode/scripts/load_godmode.py")
)).read())
...
exec(open(os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.pichkoo")), "skills/red-teaming/godmode/scripts/parseltongue.py")).read())
