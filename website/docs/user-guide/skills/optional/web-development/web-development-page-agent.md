...
- User wants **Pichkoo itself to drive a browser** → use Pichkoo' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
