...
```powershell
iex (irm https://raw.githubusercontent.com/piyushh62/Pichkoo-AI-Agent/main/scripts/install.ps1)
```
...
```powershell
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/piyushh62/Pichkoo-AI-Agent/main/scripts/install.ps1))) -NoVenv -SkipSetup -Branch main
```
