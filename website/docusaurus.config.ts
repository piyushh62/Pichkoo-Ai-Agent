...
const config: Config = {
  ...
  url: 'https://pichkoo-agent.nousresearch.com',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'pichkoo-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/piyushh62/Pichkoo-AI-Agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/pichkoo-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://pichkoo-agent.nousresearch.com/desktop',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://pichkoo-agent.nousresearch.com',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/piyushh62/Pichkoo-AI-Agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/piyushh62/Pichkoo-AI-Agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://pichkoo-agent.nousresearch.com/desktop' },
            { label: 'GitHub', href: 'https://github.com/piyushh62/Pichkoo-AI-Agent' },
