#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Pichkoo docs site.
...
Both publish at:
  https://pichkoo-agent.nousresearch.com/docs/llms.txt
  https://pichkoo-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://pichkoo-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Pichkoo as a Python Library", None),
        ("guides/use-mcp-with-pichkoo", "Use MCP with Pichkoo", None),
        ("guides/use-voice-mode-with-pichkoo", "Use Voice Mode with Pichkoo", None),
        ("guides/use-soul-with-pichkoo", "Use SOUL.md with Pichkoo", None),
        ("guides/build-a-pichkoo-plugin", "Build a Pichkoo Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Pichkoo"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "pichkoo-agent/main/scripts/install.sh | bash`  "
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Pichkoo AI Agent — Full Documentation\n",
        (
            "This file is the entire Pichkoo AI Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Pichkoo, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://pichkoo-agent.nousresearch.com/docs\n",
        "Short index: https://pichkoo-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
