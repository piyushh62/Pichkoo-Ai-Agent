...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/use-mcp-with-pichkoo", "Use MCP with Hermes", None),
        ("guides/use-voice-mode-with-pichkoo", "Use Voice Mode with Hermes", None),
        ("guides/use-soul-with-pichkoo", "Use SOUL.md with Hermes", None),
        ("guides/build-a-pichkoo-plugin", "Build a Hermes Plugin", None),
