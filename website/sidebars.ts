  ...
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-pichkoo-agent',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-pichkoo-agent-skill-authoring',
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/optional/devops/devops-pichkoo-s6-container-supervision',
    ...
    },
    {
      ...
      items: [
        ...
        'guides/run-pichkoo-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-pichkoo',
        'guides/use-soul-with-pichkoo',
        'guides/use-voice-mode-with-pichkoo',
        'guides/build-a-pichkoo-plugin',
